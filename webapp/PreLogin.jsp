			...
			<div class="col-lg-4">
				<div class="w3-card-4" style="background: #616161">
					...
					<div class="w3-container">
						...
						<p class="basic_text">Intrusa del mundo informático. Docente.
				...
				<div class="w3-card-4" style="background: #616161">
					...
					<div class="w3-container">
						...
						<img src="/TurismoEnElMundoMarvel_Webapp/assets/img/Fundadores/Luciano.jfif"
							alt="Avatar" class="rounded_image">
						<p class="basic_text">Ingeniero químico y reciente ingreso a la informática</p>
					</div>
				</div>
			</div>
				...
				<div class="w3-card-4" style="background: #616161">
					...
					<div class="w3-container">
						...
						<img src="/TurismoEnElMundoMarvel_Webapp/assets/img/Fundadores/Marce.png"
							alt="Avatar" class="rounded_image">
						<p class="basic_text">Psicologo medio tiempo y padre de familia tiempo completo</p>
					</div>
				</div>
			</div>
				...
				<div class="w3-card-4" style="background: #616161">
					...
					<div class="w3-container">
						...
						<img src="/TurismoEnElMundoMarvel_Webapp/assets/img/Fundadores/Guille.png"
							alt="Avatar" class="rounded_image">
						<p class="basic_text">Contador y lo llevamos en nuestros corazones</p>
					</div>
				</div>
			</div>
		</div>
